  ...
  useEffect(() => {
    ...
    ;(window as any).electron.getConfig().then((config: any) => {
      ...
      if (config.processingEnabled !== undefined)
        setProcessingEnabled(config.processingEnabled)
    })
  }, [])
    ...
    <div className="app-container">
      ...
      <div className="title-bar">
        ...
        <div className="window-controls">
          <button onClick={() => win.minimize()} className="control-btn">
            <Minus size={16} strokeWidth={2} />
          </button>
          <button onClick={() => win.close()} className="control-btn close">
      ...
      <main className="content">
        <section className="settings-card">
          ...
          <div className="form-group">
            ...
            />
            <p className="hint">
              Works with Google, OpenAI, or Anthropic keys.
            </p>
          </div>
            ...
            >
              ...
              <optgroup label="Anthropic Claude 4 (Messages API)">
                ...
                <option value="claude-opus-4-20250514">
                  Claude 4.0 Opus (2025)
                </option>
                <option value="claude-sonnet-4-20250514">
                  Claude 4.0 Sonnet (2025)
                </option>
              ...
              <optgroup label="Anthropic Claude 3.7 & 3.5">
                <option value="claude-sonnet-3-7-sonnet-20250219">
                  Claude 3.7 Sonnet
                </option>

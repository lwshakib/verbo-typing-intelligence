  ...
  return (
    <div className="popup-container">
      ...
      <main className="content">
        <div className="setting-row">
          <div className="setting-info">
            ...
            <span className="setting-desc">Enable autocompletions on web pages</span>
          </div>
        ...
        <button className={`save-btn ${saved ? 'saved' : ''}`} onClick={handleSave}>
          {saved ? (
            ...
            <>
              <svg className="save-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <footer className="footer">
        <p className="footer-tip">💡 Press <kbd>Tab</kbd> to accept completions inline, or <kbd>Esc</kbd> to dismiss.</p>
      </footer>
    </div>
  )
}
